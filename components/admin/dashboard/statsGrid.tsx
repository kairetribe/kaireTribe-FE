  ...
  const stats = [
    {
      ...
      value: formatCount(dashboardStats?.totalScholarships ?? 0),
      icon: BookOpen,
    },
    {
      title: "Total Users",
      value: formatCount(dashboardStats?.totalUsers ?? 0),
      icon: Users,
    },
    {
      title: "Male Users",
      value: formatCount(dashboardStats?.maleUsers ?? 0),
      icon: User,
    },
    {
      title: "Female Users",
      value: formatCount(dashboardStats?.femaleUsers ?? 0),
      icon: UserCheck,
    },
  ];
