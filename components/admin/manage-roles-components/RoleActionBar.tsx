            ...
            <div className="flex flex-col sm:flex-row justify-between items-center gap-4 mb-8">
                ...
                <div className="flex items-center gap-3 w-full sm:w-auto">
                    ...
                    <button
                        ...
                        className="flex-1 sm:flex-none inline-flex items-center justify-center px-4 py-2.5 border border-transparent text-sm font-medium rounded-lg text-white bg-primary hover:bg-primary/90 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary shadow-md hover:shadow-lg transition-shadow"
                    >
                        <CirclePlus className="h-5 w-5 mr-2" />
                        Create new profile
                    </button>
