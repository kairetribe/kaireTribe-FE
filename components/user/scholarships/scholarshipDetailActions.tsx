...
export const ScholarshipDetailActions = ({
  scholarshipId,
  scholarshipName,
  applyLink,
}: ScholarshipDetailActionsProps) => {
  ...
  const isApplying = pendingApplyId === scholarshipId;
  ...
  const handleApply = () => {
    if (!isAuthenticated) return;
    startApply({ id: scholarshipId, name: scholarshipName, link: applyLink });
  };
